    ...
    >
      ...
      <div className="flex items-center gap-3 sm:gap-4" dir="ltr">
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={() => navigate(-1)}
          className="bg-white/80 backdrop-blur-md rounded-full p-2 sm:p-3 text-[#2E3D88] hover:bg-[#2E3D88] hover:text-white transition-all duration-300 shadow-lg border border-gray-300 dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-[#2E3D88] dark:border-gray-600"
        >
