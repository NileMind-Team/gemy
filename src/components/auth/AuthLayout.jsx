...
export default function AuthLayout({
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-[#f0f3ff] to-[#d9e0f5] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-4 relative font-sans overflow-hidden transition-colors duration-300`}
      dir="rtl"
    >
      ...
      {!showWelcome && !isProcessingGoogle && (
        <button
          onClick={onBack}
          className="fixed top-6 left-6 z-50 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md hover:bg-[#2E3D88] hover:text-white rounded-full p-3 text-[#2E3D88] dark:text-gray-300 border border-[#2E3D88] dark:border-gray-600 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl"
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-[#2E3D88]/5 to-transparent rounded-tr-3xl"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 min-h-[600px]">
          ...
          {!isProcessingGoogle && (
            <motion.div
              ...
              className="lg:col-span-1 bg-gradient-to-br from-[#f0f3ff] to-[#d9e0f5] dark:from-gray-800 dark:to-gray-700 rounded-l-3xl p-8 flex flex-col transition-colors duration-300 border-r border-gray-200"
            >
              {/* Brand Content */}
              <div className="space-y-6 mb-8">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white leading-tight text-right">
                  مرحباً بك في
                  <br />
                  <span className="text-[#2E3D88] block mt-2">Pharmacy</span>
                </h1>
              ...
              <div className="flex flex-col gap-3 flex-1 justify-center">
                <motion.button
                  ...
                  className={`flex items-center gap-4 px-6 py-4 rounded-xl font-semibold text-lg transition-all duration-300 border ${
                    activeTab === "login"
                      ? "bg-white dark:bg-gray-800 text-[#2E3D88] shadow-lg border-[#2E3D88]"
                      : "text-gray-600 dark:text-gray-400 hover:text-[#2E3D88] hover:bg-white/50 dark:hover:bg-gray-700/50 border-gray-300 dark:border-gray-600 hover:border-[#2E3D88]/50"
                  }`}
                >
                  <div
              ...
              <div className="mt-6 mb-6">
                <div className="relative mb-6">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-3 bg-gradient-to-br from-[#f0f3ff] to-[#d9e0f5] dark:from-gray-800 dark:to-gray-700 text-gray-500 dark:text-gray-400">
                      أو تابع باستخدام
                    </span>
                  </div>
                </div>
