  ...
  return (
    ...
    >
      <div className="text-center mb-2">
        <h2 className="text-2xl font-bold text-[#FB7D2D]">إنشاء حساب جديد</h2>
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="relative group">
            <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-3">
              <FaUser className="text-[#FB7D2D] text-lg transition-all duration-300 group-focus-within:scale-110" />
            </div>
            <input
              type="text"
              name="firstName"
              ...
              className="w-full border-2 border-gray-300 bg-white dark:bg-gray-800 text-black dark:text-white rounded-xl pr-10 pl-3 py-3.5 outline-none focus:ring-2 focus:ring-[#FB7D2D] focus:border-[#FB7D2D] transition-all duration-200 group-hover:border-[#FB7D2D] text-sm text-right"
            />
          </div>
        ...
        <div className="relative group">
          <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-4">
            <FaPhone className="text-[#FB7D2D] text-lg transition-all duration-300 group-focus-within:scale-110" />
          </div>
          <input
            type="tel"
            name="phoneNumber"
        ...
        <div className="relative group">
          <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-4">
            <FaLock className="text-[#FB7D2D] text-lg transition-all duration-300 group-focus-within:scale-110" />
          </div>
          <input
            ...
            className="w-full border-2 border-gray-300 bg-white dark:bg-gray-800 text-black dark:text-white rounded-xl pr-12 pl-12 py-3.5 outline-none focus:ring-2 focus:ring-[#FB7D2D] focus:border-[#FB7D2D] transition-all duration-200 group-hover:border-[#FB7D2D] text-right"
          />
          <div className="absolute inset-y-0 left-0 flex items-center justify-center pl-4">
            <div
              onClick={onToggleRegisterPassword}
              className="text-gray-500 dark:text-gray-400 hover:text-[#FB7D2D] cursor-pointer transition-all duration-200 hover:scale-110"
            >
              {showRegisterPassword ? (
                <FaEyeSlash size={16} />
              ) : (
      ...
      <div className="bg-red-50 dark:bg-gray-700 p-3 rounded-xl border-2 border-gray-300 dark:border-gray-600 space-y-2 transition-colors duration-300">
        <p className="text-sm font-semibold text-[#FB7D2D] text-right">
          متطلبات كلمة المرور:
        </p>
